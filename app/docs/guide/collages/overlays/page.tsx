    ...
    <div className="bg-white pt-24 pb-16">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <article>
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Adding Overlays</h1>
            ...
            <div className="p-4 bg-blue-50 rounded-xl border border-blue-100">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-blue-800"> Overlays must be PNG files with transparency. You can add multiple overlays and reorder them between the <strong>Above Frames</strong> and <strong>Below Frames</strong> sections.</span>
                </div>
              </div>
            </div>
